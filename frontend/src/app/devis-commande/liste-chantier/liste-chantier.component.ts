...
@Component({
    selector: 'app-liste-chantier-devis',
    templateUrl: './liste-chantier.component.html',
    styleUrls: ['./liste-chantier.component.scss'],
    animations: [fadeIn, fadeOut]
})
export class ListeChantierDevisComponent implements OnInit, Recherchable, QueryBuildable {
    @Input() isModal: boolean = false;
    @Output() emitChantier: EventEmitter<Chantier> = new EventEmitter<Chantier>();
